<template>
	<view class="fix-top-window">
		...
		<view class="uni-container">
			<unicloud-db ref="udb" collection="opendb-news-articles"
				field="_id,article_status,avatar,comment_count,comment_status,content,create_time,excerpt,last_modify_date,like_count,publish_date,title,type,user_id" :where="where"
...
<script>
	...
	const dbSearchFields = ['title'] // 支持模糊搜索的字段列表	// 分页配置
	const pageSize = 20
	const pageCurrent = 1
